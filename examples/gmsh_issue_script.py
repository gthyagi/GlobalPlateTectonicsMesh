...
# +
# # slab surface mesh
# slab_surf_mesh = pv.read(f'{output_dir}sum_top_surf_mesh_mmg.stl')
# slab_surf_mesh.plot()

# +
# here i am using geometry inbuilt cad

def SegmentofSphere_geo(
...
# create refined mesh
SegmentofSphere_geo(radiusOuter=r_o, radiusInner=r_i,
                    longitudeExtent=lon_ext, latitudeExtent=lat_ext,
                    cellSize=cellsize, filename=f'{output_dir}{meshname}_geo.vtk')


# +
# here i am using occ inbuilt cad
